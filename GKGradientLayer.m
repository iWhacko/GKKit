...
- (id)init{
	if ((self = [super init])) {
		...
		CGColorRef color1	= [UIColor colorWithHue:0.500 saturation:0.004 brightness:0.969 alpha:1].CGColor;
		CGColorRef color2	= [UIColor colorWithHue:0.560 saturation:0.018 brightness:0.761 alpha:1].CGColor;
